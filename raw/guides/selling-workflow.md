...
2. Connect the integrations you need for payments and operations.
3. Configure the products you want to sell in the Vatly dashboard.
4. Register a webhook endpoint that Vatly can reach.
5. Create a checkout with the product IDs you want to sell.
6. Redirect the customer to the hosted checkout URL.
7. Listen for the payment webhook and fulfill the order in your app.
8. Stay prepared to handle refunds and chargebacks after the sale.
