...
description: "Vatly Laravel Package - Getting Started"
---
...
> **Note:** Testmode is automatically determined from your API key prefix. Keys starting with `test_` use testmode; keys starting with `live_` use production. No configuration needed.
